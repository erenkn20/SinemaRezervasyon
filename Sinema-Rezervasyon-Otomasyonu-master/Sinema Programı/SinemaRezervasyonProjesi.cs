...
namespace Sinema_Programı
{
    public partial class SinemaRezervasyonProjesi : Form
    {
        ...
        {
            MessageBox.Show("Bu uygulama Eren ISKIN tarafından Vize Projesi olarak kodlanmıştır", "Geliştirici Hakkında", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
